...
!function(String) {
    ...
    template("Article/Detail", function($data, $filename) {
        try {
            ...
            $line = 8, $out += $escape(Article.Author.Nickname), $out += '</div> </a> </div> <div class="viewcount pull-right"> <span>已被阅读', 
            $line = 12, $out += $escape(Article.ViewCount), $out += '次</span> </div> </div> <div class="content">', 
            $line = 15, $out += $string(Article.Content), $out += "</div> ", $line = 16, RelatedBooks && ($out += ' <div class="section row-fluid similarBooks"> <div class="row-fluid title"> <span>相关书籍</span> </div> <div class="row-fluid"> ', 
            $line = 22, $each(RelatedBooks, function($value) {
                $out += ' <div class="book span3"> <a href="../Book/Detail.html?id=', $line = 24, 
                $out += $escape($value.Id), $out += '"> <div class="bookCover"> <div class="wrapper"><img src="', 
                $line = 26, $out += $escape($value.ImageUrl), $out += '" alt=""></div> </div> <div class="bookTitle text-center">', 
                $line = 28, $out += $escape($value.Title), $out += "</div> </a> </div> ", $line = 31;
            }), $out += " </div> </div> ", $line = 34), $out += ' </div> <div class="row-fluid response text-center"> <a href="Response.html?id=', 
            $line = 37, $out += $escape(Article.Id), $out += "&authorId=", $line = 37, $out += $escape(Article.Author.Id), 
            $out += '"> <span class="glyphicons comments">', $line = 38, Article.ResponseSum > 0 ? ($line = 38, 
            $out += $escape(Article.ResponseSum), $out += "条评论", $line = 38) : ($out += "没有评论", 
            $line = 38), $out += "</span> </a> </div>", new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",
    ...
    template("Book/Detail", function($data, $filename) {
        try {
            ...
            $line = 23, IsLogin === !0 && ($out += ' <div class="section row-fluid readStatus"> <div class="row-fluid status"> <div class="span4 text-center statusAction" data-statuscode="wanttoread"> <a href="#"> <div class="wanttoread ', 
            $line = 28, UserBookStatus && ($line = 28, 1 === UserBookStatus.Status && ($out += "active", 
            $line = 28), $line = 28), $out += '"> <img src="../public/img/WantToRead.png" alt="" class="pull-left"> <div class="pull-left" id="wanttoread">我想读</div> </div> </a> </div> <div class="span4 text-center statusAction" data-statuscode="read"> <a href="WriteReview.html?bookid=', 
            ...
            $line = 35, $out += $escape(Book.Title), $out += '"> <div class="read ', $line = 36, 
            UserBookStatus && ($line = 36, 4 === UserBookStatus.Status && ($out += "active", 
            $line = 36), $line = 36), $out += '"> <img src="../public/img/Read.png" alt="" class="pull-left"> <div class="pull-left" id="read">我读过</div> </div> </a> </div> <div class="span4 text-center statusAction" data-statuscode="giveup"> <a href="WriteReview.html?bookid=', 
            ...
            $line = 43, $out += $escape(Book.Title), $out += '"> <div class="giveup ', $line = 44, 
            UserBookStatus && ($line = 44, 3 === UserBookStatus.Status && ($out += "active", 
            $line = 44), $line = 44), $out += '"> <img src="../public/img/GiveUp.png" alt="" class="pull-left"> <div class="pull-left" id="giveup">弃读</div> </div> </a> </div> </div> <div class="row-fluid selfComment ', 
            ...
            $line = 127), $out += " ", $line = 128, "" !== Book.Url && ($out += " ", $line = 129, 
            IsLogin === !0 ? ($out += ' <div class="readButton text-center login" data-url="', 
            $line = 130, $out += $escape(Book.Url), $out += '"> <span class="before"></span> <span>开始阅读</span> <span class="after"></span> </div> ', 
            $line = 135) : ($out += ' <div class="readButton text-center" data-url="', $line = 136, 
            $out += $escape(Book.Url), $out += '">开始阅读</div> ', $line = 137), $out += " ", $line = 138), 
            $out += ' <div class="section row-fluid summary"> <div class="row-fluid title">内容简介</div> <div class="row-fluid summaryContent">', 
            $line = 141, $out += $escape(Book.Summary), $out += '</div> <div class="expand pull-right"></div> </div> ', 
            $line = 144, Book.Comments && ($out += ' <div class="section row-fluid comments"> <div class="row-fluid title"> <span>短评（', 
            $line = 147, $out += $escape(Book.CommentSum), $out += '）</span> <span class="more pull-right"><a href="MoreComments.html?bookid=', 
            $line = 148, $out += $escape(Book.Id), $out += '">更多&nbsp;...</a></span> </div> <div class="row-fluid"> ', 
            $line = 151, $each(Book.Comments, function($value) {
                $out += ' <div class="row-fluid comment" id="', $line = 152, $out += $escape($value.Id), 
                $out += '"> <a href="../Comment/Detail.html?id=', $line = 153, $out += $escape($value.Id), 
                $out += '"></a> <div class="row-fluid"><div class="author pull-left"><a href="../People/Detail.html?nickname=', 
                $line = 154, $out += $escape($value.Author.Nickname), $out += '">', $line = 154, 
                $out += $escape($value.Author.Nickname), $out += '</a></div><div class="cmtScore pull-left" data-score="', 
                $line = 154, $out += $escape($value.Score), $out += '"></div></div> <div class="row-fluid"><div class="content">', 
                $line = 155, $out += $escape($value.Content), $out += '</div></div> <div class="row-fluid mega"> <table class="pull-right"> <tr> <td> <div class="glyphicons comments">', 
                $line = 160, $out += $escape($value.ResponseSum), $out += '</div> </td> <td> <div class="glyphicons thumbs_up">', 
                $line = 163, $out += $escape($value.LikeSum), $out += "</div> </td> </tr> </table> </div> </div> ", 
                $line = 169;
            }), $out += " </div> </div> ", $line = 172), $out += " ", $line = 173, Book.Reviews && ($out += ' <div class="section row-fluid reviews"> <div class="row-fluid title"> <span>书评（', 
            $line = 176, $out += $escape(Book.ReviewSum), $out += '）</span> <span class="more pull-right"><a href="MoreReviews.html?bookid=', 
            $line = 177, $out += $escape(Book.Id), $out += '">更多&nbsp;...</a></span> </div> <div class="row-fluid"> ', 
            $line = 180, $each(Book.Reviews, function($value) {
                $out += ' <div class="review row-fluid" id="', $line = 181, $out += $escape($value.Id), 
                $out += '"> <a href="../Review/Detail.html?id=', $line = 182, $out += $escape($value.Id), 
                $out += '"></a> <div class="megaInfo row-fluid"> <div class="userAvatar pull-left"><a href="../People/Detail.html?nickname=', 
                $line = 184, $out += $escape($value.Author.Nickname), $out += '"><img src="', $line = 184, 
                ...
                $line = 187, $out += $escape($value.Author.Nickname), $out += '">', $line = 187, 
                $out += $escape($value.Author.Nickname), $out += '</a></div> <div class="reviewScore pull-left" data-score="', 
                $line = 188, $out += $escape($value.Score), $out += '"></div> <div class="mega pull-right"> <table> <tr> <td> <div class="glyphicons comments">', 
                $line = 193, $out += $escape($value.ResponseSum), $out += '</div> </td> <td> <div class="glyphicons thumbs_up">', 
                $line = 196, $out += $escape($value.LikeSum), $out += '</div> </td> </tr> </table> </div> </div> <div class="secondRow row-fluid"> <div class="reviewTitle pull-left dotdotdotForLongText">', 
                $line = 203, $out += $escape($value.Title), $out += '</div> </div> </div> </div> <div class="content row-fluid">', 
                $line = 207, $out += $string($substring($value.Content, 0, 80)), $out += "</div> </div> ", 
                $line = 209;
            }), $out += " </div> </div> ", $line = 212), $out += " ", $line = 213, RelatedBooklists && ($out += ' <div class="section row-fluid booklists"> <div class="row-fluid title"> <span>收藏这本书的书单</span> </div> <div class="row-fluid"> ', 
            $line = 219, $each(RelatedBooklists, function($c) {
                $out += ' <div class="booklist pull-left span6"> <a href="../Booklist/Detail.html?id=', 
                $line = 221, $out += $escape($c.Id), $out += '"></a> <div class="row-fluid booklistTitle"><div class="titleText pull-left">', 
                $line = 222, $out += $escape($c.Title), $out += '</div><div class="pull-right">(', 
                $line = 222, $out += $escape($c.BookSum), $out += ')</div></div> <div class="row-fluid nickname">', 
                $line = 223, $out += $escape($c.Author.Nickname), $out += '</div> <div class="row-fluid"> ', 
                $line = 225, $each($c.BookCoverUrls, function($d, $j) {
                    $out += " ", $line = 226, 3 >= $j && ($out += ' <div class="bookCover span3"><div class="wrapper"><img src="', 
                    $line = 227, $out += $escape($d), $out += '" alt=""></div></div> ', $line = 228), 
                    $out += " ", $line = 229;
                }), $out += ' </div> <div class="row-fluid mega"> <div class="span6"><div class="glyphicons comments">', 
                $line = 232, $out += $escape($c.ResponseSum), $out += '</div></div> <div class="span6"><div class="glyphicons heart">', 
                $line = 233, $out += $escape($c.SubscribeSum), $out += "</div></div> </div> </div> ", 
                $line = 236;
            }), $out += " </div> </div> ", $line = 239), $out += " ", $line = 240, BooksWithSameAuthor && ($out += ' <div class="section row-fluid booksBySameAuthor"> <div class="row-fluid title"> <span>作者的其他书</span> </div> <div class="row-fluid"> ', 
            $line = 246, $each(BooksWithSameAuthor, function($value) {
                $out += ' <div class="sameBook span3"> <a href="Detail.html?id=', $line = 248, $out += $escape($value.Id), 
                $out += '"> <div class="bookCover"> <div class="wrapper"><img src="', $line = 250, 
                $out += $escape($value.ImageUrl), $out += '" alt=""></div> </div> <div class="bookTitle text-center">', 
                $line = 252, $out += $escape($value.Title), $out += "</div> </a> </div> ", $line = 255;
            }), $out += " </div> </div> ", $line = 258), $out += " ", $line = 259, Book.SimilarBooks && ($out += ' <div class="section row-fluid similarBooks"> <div class="row-fluid title"> <span>喜欢这本书的人也喜欢</span> </div> <div class="row-fluid"> ', 
            $line = 265, $each(Book.SimilarBooks, function($c, $i) {
                $out += " ", $line = 266, 3 >= $i && ($out += ' <div class="sameBook span3"> <a href="Detail.html?id=', 
                $line = 268, $out += $escape($c.Id), $out += '"> <div class="bookCover"> <div class="wrapper"><img src="', 
                $line = 270, $out += $escape($c.ImageUrl), $out += '" alt=""></div> </div> <div class="bookTitle text-center">', 
                $line = 272, $out += $escape($c.Title), $out += "</div> </a> </div> ", $line = 275), 
                $out += " ", $line = 276;
            }), $out += " </div> </div> ", $line = 279), $out += " </div>", new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",
