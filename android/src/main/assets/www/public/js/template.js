...
!function(String) {
    ...
    template("Article/Detail", function($data, $filename) {
        try {
            ...
            $out += '"> <div class="row-fluid title">', $line = 2, $out += $escape(Article.Title), 
            $out += '</div> <div class="info row-fluid"> <div class="user pull-left" id="', 
            $line = 4, $out += $escape(Article.Author.Id), $out += '"> <a href="../People/Detail.html?nickname=', 
            $line = 5, $out += $escape(Article.Author.Nickname), $out += '"> <div class="avatar pull-left"><img src="', 
            $line = 6, $out += $escape(Article.Author.AvatarUrl), $out += '" alt="" class="img-circle"></div> <div class="nickname pull-left">', 
            $line = 7, $out += $escape(Article.Author.Nickname), $out += '</div> </a> </div> </div> <div class="content">', 
            $line = 11, $out += $string(Article.Content), $out += "</div> ", $line = 12, RelatedBooks && ($out += ' <div class="section row-fluid similarBooks"> <div class="row-fluid title"> <span>相关书籍</span> </div> <div class="row-fluid"> ', 
            $line = 18, $each(RelatedBooks, function($value) {
                $out += ' <div class="book span3"> <a href="../Book/Detail.html?id=', $line = 20, 
                $out += $escape($value.Id), $out += '"> <div class="bookCover"> <div class="wrapper"><img src="', 
                $line = 22, $out += $escape($value.ImageUrl), $out += '" alt=""></div> </div> <div class="bookTitle text-center">', 
                $line = 24, $out += $escape($value.Title), $out += "</div> </a> </div> ", $line = 27;
            }), $out += " </div> </div> ", $line = 30), $out += ' </div> <div class="row-fluid mega"> <table class="pull-right"> <tr> <td class="response"> <a href="Response.html?id=', 
            $line = 36, $out += $escape(Article.Id), $out += '"> <span class="glyphicons comments">', 
            $line = 37, $out += $escape(Article.ResponseSum), $out += '</span> </a> </td> <td class="viewcount"> <div><span class="glyphicons eye_open">', 
            $line = 41, $out += $escape(Article.ViewCount), $out += "</span></div> </td> </tr> </table> </div>", 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,
    ...
    template("Article/List", function($data, $filename) {
        try {
            ...
            $data.$i, $utils.$escape), Tags = $data.Tags, $string = ($data.$d, $data.$j, $utils.$string), $substring = $helpers.$substring, $out = "";
            return $out += '<div class="container"> ', $line = 2, $each(Data, function($c) {
                $out += ' <div class="article row-fluid"> <a href="Detail.html?id=', $line = 4, 
                $out += $escape($c.Id), $out += '"></a> <div class="row-fluid"> <h4>', $line = 6, 
                $out += $escape($c.Title), $out += '</h4> </div> <div class="row-fluid"> <ul class="unstyled inline"> ', 
                $line = 10, $each(Tags, function($d) {
                    $out += ' <li class="badge">', $line = 11, $out += $escape($d), $out += "</li> ", 
                    $line = 12;
                }), $out += ' </ul> </div> <div class="row-fluid">', $line = 15, $out += $string($substring($c.Content, 0, 30)), 
                $out += "</div> </div> ", $line = 17;
    ...
    template("Billboard/Index", function($data, $filename) {
        try {
            var $utils = this, $helpers = $utils.$helpers, $line = 0, $each = $utils.$each, Data = $data.Data, $escape = ($data.$c, 
            $data.$i, $utils.$escape), $string = ($data.$d, $data.$j, $utils.$string), $sub = $helpers.$sub, $out = "";
            return $out += '<div class="container"> ', $line = 2, $each(Data, function($c) {
                ...
                $line = 8, $out += $escape($c.Title), $out += '</h4></div> <div class="row-fluid">更新于', 
                $line = 9, $out += $escape($c.CreationTime), $out += '</div> <div class="row-fluid description">', 
                $line = 10, $out += $escape($c.Description), $out += '</div> </div> </div> </a> <div class="row-fluid versions"> ', 
                ...
                $line = 18), $out += '">更多<span class="halflings chevron-down"></span></div> </div> <hr> </div> ', 
                $line = 22;
            }), $out += " </div>", new String($out);
        } catch (e) {
            throw {
    ...
    template("Book/Detail", function($data, $filename) {
        try {
            ...
            $line = 19, $out += $escape(UsersumOfReading), $out += '</span><span>正在看</span></div> </div> <div class="row-fluid"></div> </div> ', 
            ...
            $line = 29), $line = 29), $out += '.png" alt="" class="pull-left"> <div class="pull-left" id="wanttoread">我想读</div> </div> </a> </div> <div class="span4 text-center statusAction" data-statuscode="read"> <a href="WriteComment.html?bookid=', 
            ...
            $line = 37), $line = 37), $out += '.png" alt="" class="pull-left"> <div class="pull-left" id="read">我读过</div> </div> </a> </div> <div class="span4 text-center statusAction" data-statuscode="giveup"> <a href="WriteComment.html?bookid=', 
            ...
            $line = 75, $out += $escape(UserReview.Title), $out += '</div> <div class="pull-right timeStamp">', 
            $line = 76, $out += $escape(UserReview.CreationTime), $out += '</div> </div> <div class="content row-fluid">', 
            $line = 78, $out += $string($substring(UserReview.Content, 0, 80)), $out += "</div> </div> ", 
            $line = 80) : ($out += " ", $line = 81, UserComment && ($out += ' <div class="review row-fluid"> <div class="firstRow row-fluid"> <div class="nickname pull-left">我读过这本书</div> <div class="reviewScore pull-left" data-score="', 
            $line = 85, $out += $escape(UserComment.Score), $out += '"></div> <div class="mega pull-right"> <table> <tr> <td> <div class="glyphicons comments">', 
            $line = 90, $out += $escape(UserComment.ResponseSum), $out += '</div> </td> <td> <div class="glyphicons thumbs_up">', 
            $line = 93, $out += $escape(UserComment.LikeSum), $out += '</div> </td> </tr> </table> </div> </div> <div class="secondRow row-fluid"> <div class="pull-right timeStamp">', 
            $line = 100, $out += $escape(UserComment.CreationTime), $out += '</div> </div> <div class="content row-fluid">', 
            $line = 102, $out += $string($substring(UserComment.Content, 0, 80)), $out += "</div> </div> ", 
            $line = 104), $out += " ", $line = 105), $out += ' </div> </div> <div class="row-fluid action"> <div class="span6 text-center"> <div class="addToBooklist"> <img src="../public/img/AddToBooklist.png" alt="" class="pull-left"> <div class="pull-left text-left">加入我的书单</div> </div> </div> <div class="span6 text-center write"> <a href="WriteComment.html?status=read&bookid=', 
            $line = 116, $out += $escape(Book.Id), $out += "&category=", $line = 116, $out += $escape(Book.Category), 
            $out += "&bookcover=", $line = 116, $out += $escape(Book.ImageUrl), $out += "&isforman=", 
            $line = 116, $out += $escape(Book.ForMan), $out += "&booktitle=", $line = 116, $out += $escape(Book.Title), 
            ...
            $line = 125), $out += ' <div class="section row-fluid summary"> <div class="row-fluid title">内容简介</div> <div class="row-fluid summaryContent">', 
            $line = 128, $out += $escape(Book.Summary), $out += '</div> <div class="expand pull-right"></div> </div> ', 
            $line = 131, Book.Comments && ($out += ' <div class="section row-fluid comments"> <div class="row-fluid title"> <span>短评（', 
            $line = 134, $out += $escape(Book.CommentSum), $out += '）</span> <span class="more pull-right"><a href="MoreComments.html?bookid=', 
            $line = 135, $out += $escape(Book.Id), $out += '">更多&nbsp;&nbsp;&nbsp;&nbsp;></a></span> </div> <div class="row-fluid"> ', 
            $line = 138, $each(Book.Comments, function($value) {
                $out += ' <div class="row-fluid comment" id="', $line = 139, $out += $escape($value.Id), 
                $out += '"> <a href="../Comment/Detail.html?id=', $line = 140, $out += $escape($value.Id), 
                $out += '"></a> <div class="row-fluid"><div class="author pull-left"><a href="../People/Detail.html?nickname=', 
                $line = 141, $out += $escape($value.Author.Nickname), $out += '">', $line = 141, 
                $out += $escape($value.Author.Nickname), $out += '</a></div><div class="cmtScore pull-left" data-score="', 
                $line = 141, $out += $escape($value.Score), $out += '"></div></div> <div class="row-fluid"><div class="content">', 
                $line = 142, $out += $escape($value.Content), $out += '</div></div> <div class="row-fluid mega"> <table class="pull-right"> <tr> <td> <div class="glyphicons comments">', 
                $line = 147, $out += $escape($value.ResponseSum), $out += '</div> </td> <td> <div class="glyphicons thumbs_up">', 
                $line = 150, $out += $escape($value.LikeSum), $out += "</div> </td> </tr> </table> </div> </div> ", 
                $line = 156;
            }), $out += " </div> </div> ", $line = 159), $out += " ", $line = 160, Book.Reviews && ($out += ' <div class="section row-fluid reviews"> <div class="row-fluid title"> <span>书评（', 
            $line = 163, $out += $escape(Book.ReviewSum), $out += '）</span> <span class="more pull-right"><a href="MoreReviews.html?bookid=', 
            $line = 164, $out += $escape(Book.Id), $out += '">更多&nbsp;&nbsp;&nbsp;&nbsp;></a></span> </div> <div class="row-fluid"> ', 
            $line = 167, $each(Book.Reviews, function($value) {
                $out += ' <div class="review row-fluid" id="', $line = 168, $out += $escape($value.Id), 
                $out += '"> <a href="../Review/Detail.html?id=', $line = 169, $out += $escape($value.Id), 
                $out += '"></a> <div class="megaInfo row-fluid"> <div class="userAvatar pull-left"><a href="../People/Detail.html?nickname=', 
                $line = 171, $out += $escape($value.Author.Nickname), $out += '"><img src="', $line = 171, 
                ...
                $line = 174, $out += $escape($value.Author.Nickname), $out += '">', $line = 174, 
                $out += $escape($value.Author.Nickname), $out += '</a></div> <div class="reviewScore pull-left" data-score="', 
                $line = 175, $out += $escape($value.Score), $out += '"></div> <div class="mega pull-right"> <table> <tr> <td> <div class="glyphicons comments">', 
                $line = 180, $out += $escape($value.ResponseSum), $out += '</div> </td> <td> <div class="glyphicons thumbs_up">', 
                $line = 183, $out += $escape($value.LikeSum), $out += '</div> </td> </tr> </table> </div> </div> <div class="secondRow row-fluid"> <div class="reviewTitle pull-left dotdotdotForLongText">', 
                $line = 190, $out += $escape($value.Title), $out += '</div> </div> </div> </div> <div class="content row-fluid">', 
                $line = 194, $out += $string($substring($value.Content, 0, 80)), $out += "</div> </div> ", 
                $line = 196;
            }), $out += " </div> </div> ", $line = 199), $out += " ", $line = 200, RelatedBooklists && ($out += ' <div class="section row-fluid booklists"> <div class="row-fluid title"> <span>收藏这本书的书单</span> </div> <div class="row-fluid"> ', 
            $line = 206, $each(RelatedBooklists, function($c) {
                $out += ' <div class="booklist pull-left span6"> <a href="../Booklist/Detail.html?id=', 
                $line = 208, $out += $escape($c.Id), $out += '"></a> <div class="row-fluid booklistTitle"><div class="titleText pull-left">', 
                $line = 209, $out += $escape($c.Title), $out += '</div><div class="pull-right">(', 
                $line = 209, $out += $escape($c.BookSum), $out += ')</div></div> <div class="row-fluid nickname">', 
                $line = 210, $out += $escape($c.Author.Nickname), $out += '</div> <div class="row-fluid"> ', 
                $line = 212, $each($c.BookCoverUrls, function($d, $j) {
                    $out += " ", $line = 213, 3 >= $j && ($out += ' <div class="bookCover span3"><div class="wrapper"><img src="', 
                    $line = 214, $out += $escape($d), $out += '" alt=""></div></div> ', $line = 215), 
                    $out += " ", $line = 216;
                }), $out += ' </div> <div class="row-fluid mega"> <div class="span6"><div class="glyphicons comments">', 
                $line = 219, $out += $escape($c.ResponseSum), $out += '</div></div> <div class="span6"><div class="glyphicons heart">', 
                $line = 220, $out += $escape($c.SubscribeSum), $out += "</div></div> </div> </div> ", 
                $line = 223;
            }), $out += " </div> </div> ", $line = 226), $out += " ", $line = 227, BooksWithSameAuthor && ($out += ' <div class="section row-fluid booksBySameAuthor"> <div class="row-fluid title"> <span>作者的其他书</span> </div> <div class="row-fluid"> ', 
            $line = 233, $each(BooksWithSameAuthor, function($value) {
                $out += ' <div class="sameBook span3"> <a href="Detail.html?id=', $line = 235, $out += $escape($value.Id), 
                $out += '"> <div class="bookCover"> <div class="wrapper"><img src="', $line = 237, 
                $out += $escape($value.ImageUrl), $out += '" alt=""></div> </div> <div class="bookTitle text-center">', 
                $line = 239, $out += $escape($value.Title), $out += "</div> </a> </div> ", $line = 242;
            }), $out += " </div> </div> ", $line = 245), $out += " ", $line = 246, Book.SimilarBooks && ($out += ' <div class="section row-fluid similarBooks"> <div class="row-fluid title"> <span>喜欢这本书的人也喜欢</span> </div> <div class="row-fluid"> ', 
            $line = 252, $each(Book.SimilarBooks, function($c, $i) {
                $out += " ", $line = 253, 3 >= $i && ($out += ' <div class="sameBook span3"> <a href="Detail.html?id=', 
                $line = 255, $out += $escape($c.Id), $out += '"> <div class="bookCover"> <div class="wrapper"><img src="', 
                $line = 257, $out += $escape($c.ImageUrl), $out += '" alt=""></div> </div> <div class="bookTitle text-center">', 
                $line = 259, $out += $escape($c.Title), $out += "</div> </a> </div> ", $line = 262), 
                $out += " ", $line = 263;
            }), $out += " </div> </div> ", $line = 266), $out += " </div>", new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",
    ...
    template("Booklist/Detail", function($data, $filename) {
        try {
            ...
            $line = 23, $each(Books, function($value) {
                ...
                $out += '" id="', $line = 24, $out += $escape($value.Id), $out += '"> <a href="/m/book/', 
            ...
            $line = 56, $out += $escape(Id), $out += '"> <span class="glyphicons chat">', $line = 57, 
            $out += $escape(ResponseSum), $out += '</span> </a> </td> <td class="span6"> <div><span class="glyphicons heart">', 
    ...
    template("Comment/Detail", function($data, $filename) {
        try {
            ...
            $line = 22, $out += $escape(Comment.Book.Category), $out += '</div> </div> </div> </div> </div> <div class="row-fluid mega"> <table class="pull-right"> <tr> <td class="response"> <a href="Response.html?commentId=', 
    ...
    template("DirectMessage/Messages", function($data, $filename) {
        try {
            ...
            return $out += '<div class="container"> <div class="messages"> ', $line = 3, $each(Messages, function($value) {
                $out += " ", $line = 4, $value.IsMySelf === !0 ? ($out += " ", $line = 5, include("./MineMsg", $value), 
                $out += " ", $line = 6) : ($out += " ", $line = 7, include("./TheirMsg", $value), 
                $out += " ", $line = 8), $out += " ", $line = 9;
            }), $out += " </div> ", $line = 11, include("../public/InputGroup"), $out += " </div>", 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,
    ...
    template("Index/Articles", function($data, $filename) {
        try {
            ...
            $data.$index, $utils.$escape), $string = $utils.$string, $substring = $helpers.$substring, $out = "";
            return $line = 1, $each(Articles, function($value) {
                $out += ' <div class="articleItem slide"> <a href="Article/Detail.html?id=', $line = 3, 
                $out += $escape($value.Id), $out += '"></a> <img src="', $line = 4, $value.ImageUrl ? ($line = 4, 
                $out += $escape($value.ImageUrl), $line = 4) : ($out += "http://shanpowbookcover.qiniudn.com/%E5%B0%8F%E7%BC%96%E5%81%B7%E6%87%92%E6%B2%A1%E9%85%8D%E5%9B%BE.png", 
                $line = 4), $out += '" alt=""> <div class="titleWrapper"><div class="articleTitle">', 
                $line = 5, $out += $string($substring($value.Title, 0, 50)), $out += "</div></div> </div> ", 
                $line = 7;
            }), new String($out);
        } catch (e) {
            throw {
    ...
    template("Index/Main", function($data, $filename) {
        try {
            var $utils = this, $line = ($utils.$helpers, 0), include = function(filename, data) {
                ...
                var text = $utils.$include(filename, data, $filename);
                return $out += text;
            }, $escape = $utils.$escape, ch = $data.ch, $each = $utils.$each, RecommendedReviews = $data.RecommendedReviews, $out = ($data.$value, 
            $data.$index, "");
            return $out += '<div class="container"> <div class="row-fluid slides section"> ', 
            $line = 3, include("./Articles"), $out += ' </div> <div class="row-fluid hot_ranking section"> <div class="title row-fluid"> <h4> <span>新鲜热榜</span> <span class="more pull-right"><a href="Billboard/Index.html">更多&nbsp;&nbsp;&nbsp;&nbsp;></a></span> </h4> </div> <div class="rankinglist row-fluid"> ', 
            $line = 13, include("./Billboards"), $out += ' </div> </div> <div class="row-fluid wizard section"> <div class="title row-fluid"> <h4> <span>为您推荐</span> <span class="more pull-right hide"><a href="Book/Recommendation.html">一键治书荒</a></span> </h4> </div> <div class="row-fluid bookRecommended"> ', 
            $line = 24, include("./Wizard"), $out += ' </div> </div> <div class="row-fluid reviews section"> <div class="title row-fluid"> <h4> <span>推荐书评</span> <span class="more pull-right"><a href="Review/All.html?ch=', 
            $line = 31, $out += $escape(ch), $out += '">更多&nbsp;&nbsp;&nbsp;&nbsp;></a></span> </h4> </div> <div class="unstyled"> ', 
            $line = 35, $each(RecommendedReviews, function($value) {
                $out += " ", $line = 36, include("../public/Review", $value), $out += " ", $line = 37;
    ...
    template("MessageCenter/DirectMessage", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(Data, function($value) {
                ...
                $line = 2), $out += '"> <div class="userAvatar span2"> <a href="file:///android_asset/www/People/Detail.html?nickname=', 
    ...
    template("MessageCenter/Response", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(Data, function($value) {
                ...
                $line = 2), $out += '"> <a href="', $line = 3, $out += $escape($value.AnchorUrl), 
                $out += '"></a> ', $line = 4, $value.IsRead === !1 && ($out += '<div class="unread-indicator"></div>', 
                $line = 4), $out += ' <div class="userAvatar span2"> <a href="file:///android_asset/www/People/Detail.html?nickname=', 
                $line = 6, $out += $escape($value.FromUser.Nickname), $out += '"><img src="', $line = 6, 
                $out += $escape($value.FromUser.AvatarUrl), $out += '" alt="" class="img-circle"></a> </div> <div class="info span9"> <div class="row-fluid info"> <div class="span9 dotdotdotForLongText"><a href="file:///android_asset/www/People/Detail.html?nickname=', 
                $line = 10, $out += $escape($value.FromUser.Nickname), $out += '">', $line = 10, 
                $out += $escape($value.FromUser.Nickname), $out += "</a>&nbsp;", $line = 10, $out += $escape($value.Message), 
                $out += '</div> <div class="span3 text-right">', $line = 11, $out += $escape($value.CreationTime), 
                $out += '前</div> </div> <div class="content ', $line = 13, 6 === $value.Action && ($out += "glyphicons thumbs_up", 
                $line = 13), $out += " ", $line = 13, 7 === $value.Action && ($out += "glyphicons thumbs_down", 
                $line = 13), $out += '">', $line = 13, $out += $escape($value.Content), $out += "</div> </div> </div> <hr> ", 
                $line = 17;
            }), new String($out);
        } catch (e) {
            throw {
    ...
    template("MessageCenter/Update", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(Data, function($value) {
                $out += ' <div class="row-fluid msg ', $line = 2, $value.IsRead === !1 && ($out += "unread", 
                $line = 2), $out += '"> <div class="bookcover span2"> <a href="file:///android_asset/www/Book/Detail.html?id=', 
                ...
                $line = 13, $out += $string($substring($value.Content, 0, 50)), $out += '</div> </div> </div> <a href="', 
                $line = 16, $out += $escape($value.AnchorUrl), $out += '"></a> ', $line = 17, $value.IsRead === !1 && ($out += '<div class="unread-indicator"></div>', 
                $line = 17), $out += " </div> <hr> ", $line = 20;
            }), new String($out);
        } catch (e) {
            throw {
                filename: $filename,
    ...
    template("People/Detail", function($data, $filename) {
        try {
            ...
            $out += '的阅读记录</span> <span class="badge pull-right"><a href="Books.html?nickname=', 
            $line = 28, $out += $escape(Nickname), $out += '">更多&nbsp;&nbsp;&nbsp;&nbsp;></a></span> </div> <div class="row-fluid books"> ', 
            ...
            $out += "收藏的书单</div> </a> </div> </div> </div>", new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",
    ...
    template("Review/Detail", function($data, $filename) {
        try {
            ...
            $line = 21, $out += $escape(Review.Book.Category), $out += '</div> </div> </div> </div> </div> <div class="row-fluid mega"> <table class="pull-right"> <tr> <td class="response"> <a href="Response.html?reviewId=', 
    ...
    template("public/ActionBar", '<div class="actionbar row-fluid"> <div class="actionbar-section left-button pull-left"> <div class="slide-menu"><div class="glyphicons show_lines"></div></div> <div class="back"><div class="glyphicons chevron-left"></div></div> </div> <div class="actionbar-section center pull-left"> <div class="page-title pull-left"></div> <div class="btn-group pull-left channel"> <a class="btn btn-link dropdown-toggle" data-toggle="dropdown" href="#"> <img src="public/img/Crown.png" alt="" class="current-channel pull-left"> <div class="arrow pull-left"></div> </a> <ul class="dropdown-menu"> <li><a href="?ch=m"><img src="public/img/Crown.png" alt=""></a></li> <li><a href="?ch=f"><img src="public/img/Crown_Woman.png" alt=""></a></li> </ul> </div> </div> <div class="actionbar-section center pull-left hide loading"> <div class="pullingText">下拉刷新...</div> </div> <div class="actionbar-section right-button pull-right"> <div class="buttons"> <a href="file:///android_asset/www/Search/Index.html" class="button hide glyphicons search"></a> <div class="write hide"> <div class="pull-left left active">短评</div> <div class="pull-left right">长评</div> </div> <div class="message-center hide"><a href="file:///android_asset/www/MessageCenter/Index.html" class="glyphicons envelope"></a></div> </div> </div> <div class="pullbar"></div> </div> <div class="spinner"></div>'), 
    /*v:2*/
    ...
    template("public/BookWithComment", function($data, $filename) {
        try {
            ...
            $line = 15, Comment && ($out += ' <div class="comment row-fluid"> <div class="span3 text-right">看点</div> <div class="span9">', 
            $line = 18, $out += $escape(Comment), $out += "</div> </div> ", $line = 20), $out += " </li>", 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,
    ...
    template("public/InputGroup", '<div class="postResponse row-fluid"> <textarea id="replyInput" type="text" class="span10" name="q" rows="1"></textarea> <div id="submit" class="glyphicons ok_2"></div> </div> <script type="text/javascript"> autoTextarea($("#replyInput")[0], 10, 200); </script>'), 
    /*v:2*/
    template("public/Response", function($data, $filename) {
        try {
            ...
            return $out += '<div class="response row-fluid" id="', $line = 1, $out += $escape(Id), 
            $out += '"> <div class="avatar pull-left span2"> <a href="../People/Detail.html?nickname=', 
            $line = 3, $out += $escape(Author.Nickname), $out += '"><img src="', $line = 3, 
            $out += $escape(Author.AvatarUrl), $out += '" alt="" class="img-circle"></a> </div> <div class="responseContent pull-left span10"> <div class="author row-fluid"> <a href="../People/Detail.html?nickname=', 
            $line = 7, $out += $escape(Author.Nickname), $out += '" class="pull-left"><strong>', 
            $line = 7, $out += $escape(Author.Nickname), $out += '</strong></a>说： <a href="#" class="responseBtn pull-right">回复</a> </div> <div class="mega row-fluid"> <div class="responseText">', 
            $line = 11, $out += $escape(Content), $out += '</div> <div class="timestamp pull-right">', 
            $line = 12, $out += $escape(CreationTime), $out += "前</div> </div> </div> </div>", 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,
    ...
    template("public/Responses", function($data, $filename) {
        try {
            ...
            }), $out += " </div> ", $line = 6, IsLogin === !0 && ($out += " ", $line = 7, include("./InputGroup"), 
            $out += " ", $line = 8), new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",
