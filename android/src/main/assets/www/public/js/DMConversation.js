...
var DidGetNewestMessageData, DidGetOlderMessageData, DidPostMessage;
...
DidGetOlderMessageData = function(data, rawData) {
  var messagesHTML;
  if (data.Data != null) {
    window.conversations = data.Data.concat(window.conversations);
  }
