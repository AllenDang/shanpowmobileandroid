...
var AddUrlToLocalStorage, CenterTitle, DidGetUnreadCount, GetBack, GetToken, GetUnreadMessageCount, IsUsernameMentioned, PopHistoryState, PullToRefresh, PushHistoryState, RequestAjax, RequestDataWithParam, ShowLoadingError, TimeStamp, UpdateUnreadMessageCount, autoTextarea, getQueryString,
...
RequestDataWithParam = function(options) {
  ...
  $.ajax({
    ...
    beforeSend: (function(jqXHR, settings) {
      if (shouldShowSpinner && options.type !== "POST") {
...
UpdateUnreadMessageCount = function(cnt) {
