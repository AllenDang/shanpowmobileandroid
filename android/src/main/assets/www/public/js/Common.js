...
var AddUrlToLocalStorage, DidGetUnreadCount, GetBack, GetToken, GetUnreadMessageCount, IsUsernameMentioned, PullToRefresh, RequestAjax, RequestDataWithParam, TimeStamp, autoTextarea, getQueryString,
  ...
  $.ajax({
    ...
    success: (function(data) {
      ...
      if ((_ref4 = window.shouldCache) != null ? _ref4 : true) {
        ...
        }), null, "CachedIOHelper", "set", ["" + options.type + ":" + options.url, data]);
      }
      if (data.Result === true) {
