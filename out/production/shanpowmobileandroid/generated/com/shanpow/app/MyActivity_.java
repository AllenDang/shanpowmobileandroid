    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        editTextSearch = ((EditText) hasViews.findViewById(id.editTextSearch));
        okButton = ((Button) hasViews.findViewById(id.okButton));
        {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        MyActivity_.this.okButtonClicked();
                    }
    ...
    public void updateUi(final String result) {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                MyActivity_.super.updateUi(result);
            }
    ...
    public void showToast(final String msg) {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                MyActivity_.super.showToast(msg);
            }
    ...
    public void onSearch(final String query) {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    MyActivity_.super.onSearch(query);
                } catch (Throwable e) {
